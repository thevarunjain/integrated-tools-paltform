package com.IntegratedTools.JIRA.JiraClient;
...
public class JiraClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JiraClient myJiraClient = new JiraClient("abhijira911", "Tomandjerry1$", "http://54.153.16.204:8080");

        final String issueKey = myJiraClient.createIssue("ID", 1L, "Issue created from JRJC");
